...
#define X_MIN_PIN (byte)19 //19==SW1==X-
#define X_MAX_PIN (byte)18 //18==SW2==X+
#define X_ENABLE_PIN (byte)27

#define Y_STEP_PIN (byte)31
#define Y_DIR_PIN (byte)33
#define Y_MIN_PIN (byte)16 //16==SW4==
#define Y_MAX_PIN (byte)17 //17==SW3==Y+
#define Y_ENABLE_PIN (byte)29

#define Z_STEP_PIN (byte)37 
#define Z_DIR_PIN (byte)39
#define Z_MIN_PIN (byte)15 //15==SW5==Z- NC
#define Z_MAX_PIN (byte)14 //14==SW6==Z+
